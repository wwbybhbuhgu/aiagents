...
import com.aiagents.asr.providers.DashScopeASRController
import com.aiagents.asr.providers.MiMoASRController
import com.aiagents.asr.providers.OpenAIRealtimeASRController
import com.aiagents.asr.providers.SherpaNcnnASRController
import com.aiagents.asr.providers.StepASRController
import com.aiagents.asr.providers.VolcengineASRController
...
private class CustomAsrStateImpl(
    ...
    private fun createController(provider: ASRProviderSetting): ASRController? {
        return when (provider) {
            ...
            is ASRProviderSetting.LocalStreamingSTT -> {
                SherpaNcnnASRController(context)
            }
        }
    }
}
