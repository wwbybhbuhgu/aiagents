package com.aiagents.ui.pages.chat
...
import com.aiagents.service.ChatError
import com.aiagents.ui.components.ai.ChatInput
import com.aiagents.ui.components.ai.FilesPicker
import com.aiagents.ui.components.ai.completion.WorkspaceCompletionProvider
import com.aiagents.ui.components.ai.useCropLauncher
import com.aiagents.ui.components.ui.permission.PermissionCamera
...
import com.aiagents.ui.hooks.EditStateContent
import com.aiagents.ui.hooks.useEditState
import com.aiagents.utils.ImageUtils
import com.aiagents.utils.base64Decode
import com.aiagents.utils.navigateToChatPage
            ...
            bottomBar = {
                ChatInput(
                    ...
                    onSendClick = {
                        ...
                        if (setting.getCurrentAssistant().workspaceId == null) {
                            toaster.show("请先在工作区设置中选择工作区", type = ToastType.Error)
                            return@ChatInput
                        }
