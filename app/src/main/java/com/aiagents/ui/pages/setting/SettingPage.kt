...
import com.aiagents.data.datastore.isNotConfigured
...
import com.aiagents.ui.components.ui.icons.DiscordIcon
import com.aiagents.ui.components.ui.icons.TencentQQIcon
import com.aiagents.ui.context.LocalNavController
import com.aiagents.ui.context.Navigator
import com.aiagents.ui.hooks.rememberColorMode
import com.aiagents.ui.theme.ColorMode
import com.aiagents.ui.theme.CustomColors
import com.aiagents.utils.joinQQGroup
        ...
        LazyColumn(
            ...
            item("generalSettings") {
                ...
                CardGroup(
                    ...
                    item(
                        onClick = { navController.navigate(Screen.SettingEnvCheck) },
                        leadingContent = { Icon(HugeIcons.Alert01, null) },
                        supportingContent = { Text(stringResource(R.string.setting_page_env_check_desc)) },
                        headlineContent = { Text(stringResource(R.string.setting_page_env_check)) },
                    )
                    item(
                    ...
                    item(
                        onClick = {
                            val docUrl = if (java.util.Locale.getDefault().language == "zh") {
                                "https://wiueiwi.wujunbo.top/docs/zh"
                            } else {
                                "https://wiueiwi.wujunbo.top/docs"
                            }
...
private val QQ_GROUPS = listOf(
    QQGroup("AIAgents 一群", "4POE46u9e_zoy1TkNfWdCvueR9CKFJdk"),
    QQGroup("AIAgents 二群", "Qsm0whzbPsm1UyNpR683ulLyMZ2Pqrw0"),
    QQGroup("AIAgents 三群", "Qc9oP-9tXioZeQEvEvI2_owWtBAIx3lS"),
)
