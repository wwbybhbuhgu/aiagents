...
import com.aiagents.data.datastore.DEFAULT_SYSTEM_TTS_ID
...
import com.aiagents.ui.pages.setting.components.ASRProviderConfigure
import com.aiagents.ui.pages.setting.components.TTSProviderConfigure
    ...
    Box {
        ...
        DropdownMenu(
            ...
            DropdownMenuItem(
                text = { Text("Gemini") },
                onClick = {
                    currentProvider = TTSProviderSetting.Gemini()
                    showTypeMenu = false
                    showBottomSheet = true
                }
            )
            ...
            DropdownMenuItem(
                text = { Text("MiniMax") },
                onClick = {
                    currentProvider = TTSProviderSetting.MiniMax()
                    showTypeMenu = false
                    showBottomSheet = true
                }
            )
            DropdownMenuItem(
                text = { Text("Qwen") },
                onClick = {
                    currentProvider = TTSProviderSetting.Qwen()
                    showTypeMenu = false
                    showBottomSheet = true
                }
            )
            DropdownMenuItem(
                text = { Text("Groq") },
                onClick = {
                    currentProvider = TTSProviderSetting.Groq()
                    showTypeMenu = false
                    showBottomSheet = true
                }
            )
            DropdownMenuItem(
                text = { Text("xAI") },
                onClick = {
                    currentProvider = TTSProviderSetting.XAI()
                    showTypeMenu = false
                    showBottomSheet = true
                }
            )
            DropdownMenuItem(
                text = { Text("MiMo") },
                onClick = {
                    currentProvider = TTSProviderSetting.MiMo()
                    showTypeMenu = false
                    showBottomSheet = true
                }
            )
            DropdownMenuItem(
                ...
                onClick = {
                    currentProvider = TTSProviderSetting.ElevenLabs()
                    showTypeMenu = false
                    showBottomSheet = true
                }
            )
            DropdownMenuItem(
                text = { Text("Step") },
                onClick = {
                    currentProvider = TTSProviderSetting.Step()
                    showTypeMenu = false
                    showBottomSheet = true
                }
            )
            DropdownMenuItem(
                text = { Text("Fish Audio") },
                onClick = {
                    currentProvider = TTSProviderSetting.FishAudio()
                    showTypeMenu = false
                    showBottomSheet = true
                }
            )
            DropdownMenuItem(
                text = { Text("本地智能 TTS") },
                onClick = {
                    currentProvider = TTSProviderSetting.LocalTTS()
                    showTypeMenu = false
                    showBottomSheet = true
                }
            )
    ...
    Box {
        ...
        DropdownMenu(
            ...
            DropdownMenuItem(
                text = { Text("本地实时语音转文本") },
                onClick = {
                    currentProvider = ASRProviderSetting.LocalStreamingSTT()
                    showTypeMenu = false
                    showBottomSheet = true
                }
            )
                ...
                Column(
                    ...
                    Text(
                        text = when (provider) {
                            ...
                            is ASRProviderSetting.LocalStreamingSTT -> "本地实时语音转文本"
                        },
                        style = MaterialTheme.typography.bodySmall,
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    )
