...
import com.aiagents.ui.components.ai.ReasoningButton
import com.aiagents.ui.components.nav.BackButton
import com.aiagents.ui.components.ui.FormItem
import com.aiagents.ui.components.ui.Select
import com.aiagents.ui.components.ui.TagsInput
import com.aiagents.ui.components.ui.UIAvatar
import com.aiagents.ui.hooks.heroAnimation
import com.aiagents.ui.theme.CustomColors
import com.aiagents.utils.toFixed
import org.koin.androidx.compose.koinViewModel
import org.koin.core.parameter.parametersOf
import kotlin.math.roundToInt
import kotlin.uuid.Uuid
import com.aiagents.data.model.Tag as DataTag
...
internal fun AssistantBasicContent(
    ...
    assistant: Assistant,
    providers: List<com.aiagents.ai.provider.ProviderSetting>,
    tags: List<DataTag>,
    ...
    Column(
        ...
        Card(
            ...
            FormItem(
                ...
                Select(
                    ...
                    optionToString = { workspace ->
                        workspace?.name ?: stringResource(R.string.assistant_page_workspace_unselected)
                    },
                )
            }
            ...
            FormItem(
                label = {
                    Text(stringResource(R.string.assistant_page_user_priority))
                },
                description = {
                    Text(stringResource(R.string.assistant_page_user_priority_desc))
                },
                modifier = Modifier.padding(8.dp),
            ) {
                OutlinedTextField(
                    value = assistant.userPriority,
                    onValueChange = {
                        onUpdate(
                            assistant.copy(
                                userPriority = it
                    ...
                    modifier = Modifier.fillMaxWidth(),
                    placeholder = {
                        Text(stringResource(R.string.assistant_page_user_priority_placeholder))
                    },
                    minLines = 2,
                    maxLines = 4,
                )
