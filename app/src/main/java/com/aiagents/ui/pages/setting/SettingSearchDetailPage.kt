...
import com.aiagents.highlight.LocalCodeHighlighter
import com.aiagents.R
import com.aiagents.ui.components.nav.BackButton
import com.aiagents.ui.components.richtext.HighlightCodeVisualTransformation
...
import com.aiagents.search.SearchResult
...
private fun SearchServiceOptionsEditor(
    ...
    when (options) {
        ...
        is SearchServiceOptions.AIAgentsOptions -> {
            AIAgentsOptions(options) { onUpdateOptions(it) }
        }
...
@Composable
internal fun AIAgentsOptions(
    options: SearchServiceOptions.AIAgentsOptions,
    onUpdateOptions: (SearchServiceOptions.AIAgentsOptions) -> Unit
) {
    FormItem(
        label = {
            Text(stringResource(R.string.search_detail_api_key))
