...
import com.aiagents.common.http.AcceptLanguageBuilder
import com.aiagents.BuildConfig
import com.aiagents.data.ai.AIRequestInterceptor
import com.aiagents.data.ai.RequestLoggingInterceptor
import com.aiagents.data.ai.transformers.AssistantTemplateLoader
import com.aiagents.data.ai.GenerationHandler
import com.aiagents.data.ai.transformers.TemplateTransformer
import com.aiagents.data.api.AIAgentsAPI
import com.aiagents.data.api.SponsorAPI
import com.aiagents.data.datastore.SettingsStore
import com.aiagents.data.db.AppDatabase
import com.aiagents.data.db.fts.MessageFtsManager
import com.aiagents.data.db.fts.SimpleDictManager
import com.aiagents.data.db.migrations.Migration_6_7
import com.aiagents.data.db.migrations.Migration_11_12
import com.aiagents.data.db.migrations.Migration_13_14
...
val dataSourceModule = module {
    ...
    single {
        ...
        Room.databaseBuilder(context, AppDatabase::class.java, "ai_agents")
        ...
        OkHttpClient.Builder()
            ...
            .addInterceptor { chain ->
                ...
                if (originalRequest.header(HttpHeaders.UserAgent) == null) {
                    requestBuilder.addHeader(HttpHeaders.UserAgent, "AIAgents-Android/${BuildConfig.VERSION_NAME}")
                }
    ...
    single<AIAgentsAPI> {
        get<Retrofit>().create(AIAgentsAPI::class.java)
    }
}
