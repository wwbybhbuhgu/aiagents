...
> [!NOTE]
> 本專案是 [rikkahub/rikkahub](https://github.com/rikkahub/rikkahub)（原 re-ovo/aiagents）的 fork。
> 在此基礎之上添加了新功能與客製化，原專案的全部功勞歸於原作者
> [rikkahub](https://github.com/rikkahub)。

## 下載

[前往 GitHub Releases 下載](https://github.com/wwbybhbuhgu/aiagents/releases/latest)

## 功能特色

- 現代化安卓 APP 設計（Material You / 預測性返回）和暗色模式
